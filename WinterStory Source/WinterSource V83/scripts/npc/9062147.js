...
var items = [{"id": 3018438, "amount": 1}, {"id": 1132261 , "amount": 1}, {"id": 4310209, "amount": 1}];
...
if (status == 0) { 
	cm.sendSimple("Do you want to change ?\r\n#L0#1 #b#z4400002##k   For   #fUI/UIWindow.img/QuestIcon/5/0##l"); 
} 

else if (status == 1) { 
	if (selection == 0) { 
		if (cm.haveItem(4400002, 1)) { 
