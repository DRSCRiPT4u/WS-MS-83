...
public class MapleCharacter extends AbstractMapleCharacterObject {
    ...
    private static final String[] BLOCKED_NAMES = {"admin", "owner", "moderator", "intern", "donor", "administrator", "FREDRICK", "help", "helper", "alert", "notice", "WinterStory", "fuck", "wizet", "fucking", "negro", "fuk", "fuc", "penis", "pussy", "asshole", "gay",
    ...
    public static MapleCharacter loadCharacterEntryFromDB(ResultSet rs, List<Item> equipped) {
        ...
        try {
            ...
            ret.WinterPoints = rs.getInt("WinterPoints");
    ...
    public void sendPolice(int greason, String reason, int duration) {
        announce(MaplePacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for %s.#k", "WinterStory", reason)));
        this.isbanned = true;
    ...
    public void autoban(String reason) {
        ...
        this.ban(reason);
        announce(MaplePacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for HACK reason.#k", "WinterStory")));
        TimerManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                client.disconnect(false, false);
    ...
    public int getWinterPoints() {
        return this.WinterPoints;
    }
    
    public void giveWinterPoints(int num) {
        this.WinterPoints += num;
    }
    
    public void setTotalWinterPoints(int num) { 
        this.WinterPoints = num;
    }
