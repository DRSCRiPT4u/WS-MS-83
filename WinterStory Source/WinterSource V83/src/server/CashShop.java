...
public class CashShop {
    public static class CashItem {
        ...
        private CashItem(int sn, int itemId, int price, long period, short count, boolean onSale, boolean isDonor) {
            this.sn = sn;
            this.itemId = itemId;
            this.price = price;
    ...
    public static class CashItemFactory {
        ...
        static {
            ...
            for (MapleData item : etc.getData("Commodity.img").getChildren()) {
                ...
                boolean isDonor = MapleDataTool.getIntConvert("isDonor", item,0) == 1;
                items.put(sn, new CashItem(sn, itemId, price, period, count, onSale, isDonor));
            }
    ...
    public static Item generateCouponItem(int itemId, short quantity) {
        CashItem it = new CashItem(77777777, itemId, 7777, ItemConstants.isPet(itemId) ? 30 : 0, quantity, true, false);
        return it.toItem();
    }
}
