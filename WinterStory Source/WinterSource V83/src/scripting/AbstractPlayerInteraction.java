...
public class AbstractPlayerInteraction {
    ...
    public void openNpc(int npcid, String script) {
        //if (c.getCM() != null) {
        //   System.out.println("test - function called but returned");
        //    return;
        //}
        ...
        try {
            ...
            //NPCScriptManager.getInstance().start(c, npcid, c.getPlayer());
    ...
    public String getItemsCommand(String search) { //search item choose system
        ...
        for (Pair<Integer, String> itemPair : MapleItemInformationProvider.getInstance().getAllItems()) {
            if (sb.length() < 32654) {
                if (itemPair.getRight().toLowerCase().contains(search.toLowerCase())) {
                    ...
                    sb.append("#b#L").append(itemID).append("#").append(itemID).append("#k - #r#z").append(itemID).append("#\r\n");
                }
            } else {
                sb.append("\r\n#bCouldn't load all items, there are too many results.\r\n");
                break;
            }
        }
        StringBuffer sbTime = new StringBuffer();
        sbTime.append("#kLoaded in ").append((double) (System.currentTimeMillis() - start) / 1000).append(" seconds.\r\n");

        return sbTime.toString() + sb.toString();
    }
