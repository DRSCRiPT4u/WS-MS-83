 ...
 *
 * @author Matze
 * @author DrScript - concurrency safety + check available slots + trade results
 */
public class MapleTrade {
    ...
    private boolean checkCompleteHandshake() {  // handshake checkout thanks to DrScript
    ...
    private void cancelHandshake(byte result) {  // handshake checkout thanks to DrScript
