...
if (status == 0) { 
	cm.sendSimple("Hello!\r\nYou must help me find the #b#z4310301##k!\r\nThey are scattered in #bXXX#k\r\nyou have to be brave to get everything out of there\r\n\r\nGood Luck !\r\n#L0##b200 #z4310301##v4310301#  For  #v4440001#"); 
} 

else if (status == 1) { 
	if (selection == 0) { 
		 if (cm.haveItem(4310301, 200)) {
			cm.gainItem(4310301, -200); 
			...
			cm.dispose(); 
				...
				cm.sendOk("#e#kI'm Sorry.\r\nYou do not have enough #b#v4310301##k"); 
				cm.dispose(); 
			} 
		} 
	}   
